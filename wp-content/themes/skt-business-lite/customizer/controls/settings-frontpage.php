...
// Slide Overlay Color
$wp_customize->add_setting( 'complete[slide_overlay_color_id]', array(
	'type' => 'option',
	'default' => '#1f365c',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'slide_overlay_color_id', array(
				'label' => __('Slide Overlay Color','complete'),
				'section' => 'slider_section',
				'settings' => 'complete[slide_overlay_color_id]',
			) ) );											
...
// Slide Font Typography And Colors
	...
	$wp_customize->add_setting('complete[slide_title1]', array(
		'type' => 'option',
		'default'	=> __('Business Consulting','complete'),
	...
	$wp_customize->add_setting('complete[slide_desc1]', array(
		'type' => 'option',
		'default'	=> __('Nullam hendrerit, lacus nluctus tempu est nesuscipit auvel hendrer ligu sed turpis.','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	...
	$wp_customize->add_setting('complete[slide_btn1]', array(
		'type' => 'option',
		'default'	=> __('View Details','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
