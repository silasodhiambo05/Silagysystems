  ...
  <div class="notice-content">
    ...
    <h2>
      <?php
							...
							printf( esc_html__( 'Thank you for installing %s.', 'skt-complete' ), '<strong>SKT Business Lite</strong>' );
							?>
    </h2>
    <p> <a href="<?php echo esc_url( admin_url( 'themes.php?page=theme-options' ) ); ?>" class="button button-primary">
      <?php
								/* translators: %s: Theme name */
								printf( esc_html__( 'Get started with %s', 'skt-complete' ), 'SKT Business Lite' );
								?>
      </a> </p>
    <?php else : ?>
