...
jQuery(document).ready(function($) {
	...
	$('.optim_expand').toggle(function(){ 
	 ...
	 $('#save').before('<span class="button button-primary backpannel" style="margin-right:23px; float:left; padding: 0 6px;"><a href="https://www.sktthemes.org/shop/skt_corp_pro/" target="_blank" style="color:#555; text-decoration:none;">Upgrade Now</a></span>');
