...
<div class="notice notice-info sf-notice-nux is-dismissible"> <span class="sf-icon"> <?php echo '<img src="' . esc_url( get_template_directory_uri() ) . '/images/logo-dark.png" width="250" />'; ?> </span>
  <div class="notice-content">
    ...
    <h2>
      <?php
							...
							printf( esc_html__( 'Thank you for installing %s.', 'skt-complete' ), '<strong>SKT Corporate Lite</strong>' );
							?>
    </h2>
    <p> <a href="<?php echo esc_url( admin_url( 'themes.php?page=theme-options' ) ); ?>" class="button button-primary">
      <?php
								/* translators: %s: Theme name */
								printf( esc_html__( 'Get started with %s', 'skt-complete' ), 'SKT Corporate Lite' );
								?>
      </a> </p>
    <?php else : ?>
...
<?php
		...
		public function admin_page() {
			...
			?>
<div class="notice notice-info sf-notice-nux"> <span class="sf-icon"> <?php echo '<img src="' . esc_url( get_template_directory_uri() ) . '/images/logo-dark.png" width="250" />'; ?> </span>
  <div class="notice-content">
