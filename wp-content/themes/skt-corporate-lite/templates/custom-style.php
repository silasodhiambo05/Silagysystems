<?php 
/**
 * The Custom Style for SKT Corporate Lite
 *
...
.skt-builder-block-title h2 small{font-family:<?php echo $content_font['font-family']; ?>;}
.skt-builder-home-section2-block .woocommerce ul.products li.product .woocommerce-loop-product__title{font-family:<?php echo $content_font['font-family']; ?>;}
...
/*-----------------------------COLORS------------------------------------*/
		...
		.header:before {border-color: transparent <?php echo $complete['head_color_id']; ?> transparent transparent !important;}
		.header:after {border-color: <?php echo $complete['head_color_id']; ?> transparent transparent transparent !important;}		
		...
		.slider-main .nivo-caption .title small{font-family:'<?php echo $slddescfont['font-family']; ?>';}
		...
		.skt-builder-home-section1-block .skt-builder-product-category-column .skt-builder-product-category-column-title a{font-family:'<?php echo $global_h2_font['font-family']; ?>';}
		
		.skt-builder-home-section3-block .skt-builder-block-title h2 small{font-family:'<?php echo $global_h2_font['font-family']; ?>';}
